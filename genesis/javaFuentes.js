document.addEventListener('DOMContentLoaded', function() {
    ...
    const materias = [
        { grupo: "02215-A", nombre: "ADMINISTRACION GENERAL", semestre: 1, creditos: 3, p1: 4.1, p2: 4.4, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "16171-Q", nombre: "MATEMATICAS I", semestre: 1, creditos: 3, p1: 4.3, p2: 3.9, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "23011-A", nombre: "SOCIOANTROPOLOGIA", semestre: 1, creditos: 2, p1: 4.3, p2: 3.7, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "32321-B", nombre: "TEORIA Y HERMENEUTICA DE LAS FINANZAS", semestre: 1, creditos: 3, p1: 3.8, p2: 4.3, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "41103-A", nombre: "DESARROLLO DEL ESPIRITU EMPRENDEDOR I", semestre: 1, creditos: 2, p1: 4.3, p2: 4.0, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "15201-B", nombre: "INFORMATICA I", semestre: 0, creditos: 0, p1: 3.8, p2: 3.6, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "45679-B", nombre: "IDENTIDAD UDES", semestre: 0, creditos: 0, p1: 5.0, p2: 4.6, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
        { grupo: "18231-B", nombre: "INGLES I", semestre: 0, creditos: 0, p1: 4.5, p2: 3.5, examen: getRandomGrade(3.6, 4.2), acumulado: getRandomGrade(3.8, 4.6) },
    ];
